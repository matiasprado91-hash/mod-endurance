...
public class ItemInstanceTaskManager implements Runnable
{
	...
	private static final String INSERT_ITEM = "INSERT INTO items (owner_id,object_id,item_id,count,enchant_level,loc,loc_data,custom_type1,custom_type2,mana_left,endurance,time) VALUES (?,?,?,?,?,?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE owner_id=VALUES(owner_id),count=VALUES(count),loc=VALUES(loc),loc_data=VALUES(loc_data),enchant_level=VALUES(enchant_level),custom_type1=VALUES(custom_type1),custom_type2=VALUES(custom_type2),mana_left=VALUES(mana_left),endurance=VALUES(endurance),time=VALUES(time)";
	...
	public void updateItems(Set<ItemInstance> items)
	{
			...
			PreparedStatement ps5 = con.prepareStatement(DELETE_PET_ITEM))
		{
			for (ItemInstance item : items)
			{
				...
				ps1.setInt(11, item.getEndurance());
				ps1.setLong(12, item.getTime());
				ps1.addBatch();
