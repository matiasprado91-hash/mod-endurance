...
import ext.mods.gameserver.EnduranceUpdate;
...
public class CreatureAttack<T extends Creature> {
    ...
    private ItemInstance _attackWeapon;
    private boolean _weaponWearApplied;
    private boolean _weaponBrokenPendingUnequip;
    ...
    private void applyWeaponWear() {
        ...
        if (_actor instanceof Player player) {
            ...
            EnduranceUpdate.send(player, _attackWeapon);
        }
